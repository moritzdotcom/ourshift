...
export default function HtmlHead({
  ...
  if (!title) title = 'OurShift';
  if (!description) description = 'Das einfache Schichtplan Tool';
  return (
    <Head>
      <title>{title}</title>
      ...
      <meta
        name="twitter:image"
        content={encodeURI('https://www.ourshift.de/logo-og.jpg')}
      />
      <meta name="twitter:url" content="https://www.ourshift.de/" />
